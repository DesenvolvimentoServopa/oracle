...
<h1 class="text-xs mb-6 text-gray-800">
    ...
    <a href="smartshare_pag.php?id_drop=9&id_usuario='.$_GET['id_usuario'].'"><i class="fas fa-list"></i> Regras Aprovadores NF</a> /
    <i class="fas fa-trash"></i> Deletar Regra Aprovadores NF
</h1>
<body>
    <div class="text-center">
        <h1 class="h3 mb-4 text-gray-800">DELETAR REGRA APROVADORES NF</h1>
    </div> 

    <form clas="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" id="deletarRegra" name="deletarRegra" method="POST" action="../bd/deletarNF.php?id='.$_GET['id'].'&id_usuario='. $_GET['id_usuario'] .'" class="form-group" required>
        ...
        <div class="form-group" style="margin-left: 480px;">    
            <a class="btn btn-success btn-user" type="button" href="smartshare_pag.php?id_drop=9&id_usuario='.$_GET['id_usuario'].'">Voltar</a>
