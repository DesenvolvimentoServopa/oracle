...
$queryCountNovo = "SELECT COUNT(*) as quantidade FROM aprovadores_nf WHERE 
...
<h1 class="text-xs mb-6 text-gray-800" style="margin-left: 109px" ;>
    ...
    <i class="fas fa-user-cog"></i></i> Atualizar Gestores NF
</h1>

<!-- INICIO DO CONTEUDO DA PÁGINA -->
<div class="container">
    <div class="col-lg-6" style="margin-left: 25%;">
        <form method="POST" action="../bd/atualizandoGestorNF.php?id_usuario=<?= $_GET['id_usuario'] ?>">
