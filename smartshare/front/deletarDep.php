...
<h1 class="text-xs mb-6 text-gray-800">
    ...
    <a href="smartshare_pag.php?id_drop=2&id_usuario='.$_GET['id_usuario'].'"><i class="fas fa-list"></i> Regras Departamento RH</a> /
    <i class="fas fa-trash"></i> Deletar Regra Departamento RH
</h1>
<body>
    <div class="text-center">
        <h1 class="h3 mb-4 text-gray-800">DELETAR REGRA DEPARTAMENTO</h1>
    </div> 
                                                                                                                                                   
    <form clas="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" id="deletarRegraDpto" name="deletarRegraDpto" method="POST" action="../bd/deletarDep.php?id='.$_GET['id'].'&id_usuario='.$_GET['id_usuario'].'" class="form-group" required>
        <div class="card shadow mb-4">
            <div class="text-center">';
            $departrh .= " WHERE d.id_departamento = ".$_GET['id']."";
                
                $resultdpto = ociparse($conn, $departrh);
        ...
        <div class="form-group" style="margin-left: 480px;">    
            <a class="btn btn-success btn-user" type="button" href="smartshare_pag.php?id_drop=2&id_usuario='.$_GET['id_usuario'].'">Voltar</a>
