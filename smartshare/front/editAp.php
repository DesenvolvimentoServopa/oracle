...
$aprov .= " AND a.id_aprovador = " .$_GET['id_aprovador']."";

$resultpes = ociparse($conn, $aprov);
...
if ($_GET['id_aprovador'] != null) {
    ...
    <div class="text-center">
        <h1 class="h3 mb-4 text-gray-800">EDIÇÃO REGRA APROVADORES</h1>
    </div>

    <div class="col-lg-6" style="margin-left: 25%;">                                                                                               
        <form id="editAp" name="editAp" method="POST" action="../bd/editAp.php?id_aprovador='.$_GET['id_aprovador'].'&id_usuario='.$_GET['id_usuario'].'">
            <!-- INICIO DROP EMPRESA -->    
