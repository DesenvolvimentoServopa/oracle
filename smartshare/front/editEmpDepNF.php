...
$empdepNF .= " WHERE e.id_empdep = ".$_GET['id_empdep']."";

$resultpes = ociparse($conn, $empdepNF);
...
<h1 class="text-xs mb-6 text-gray-800 style="margin-left: 109px;"" style="margin-left: 109px;">
    ...
    <i class="fas fa-user-plus"></i> Editar Regra Empresa Departamento NF
</h1>

<div class="text-center">
    <h1 class="h3 mb-4 text-gray-800">EDITAR REGRA EMPRESA X DEPARTAMENTO NF</h1>
</div>

<div class="col-lg-6" style="margin-left: 25%;">                                                                                                                                                                                                                          
    <form id="novaRegraEmpDep" name="novaRegraEmpDep" method="POST" action="../bd/editEmpDepNF.php?id_empdep='.$_GET['id_empdep'].'&id_usuario='. $_SESSION['id_usuario'] .'">
        <div>
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="lancarMultas" type="text" id="situacao" required>
                <option value="'.$rowempdep['LANCA_MULTAS'].'" selected>'; echo $rowempdep['LANCA_MULTAS'] == "S" ? 'SIM' : 'NÃO'; echo '</option>
                <option value="">------------------</option>
                <option value="S">SIM</option> 
                <option value="N">NÃO</option> 
            </select>
