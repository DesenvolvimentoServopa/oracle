...
<!-- Page Cabeçalho -->
<title>Nova Regra Aprovadores</title>
<h1 class="text-xs mb-6 text-gray-800" style="margin-left: 109px;">
    ...
    <i class="fas fa-user-plus"></i> Nova Regra Aprovadores
</h1>

<div class="text-center">
    <h1 class="h3 mb-4 text-gray-800">NOVA REGRA APROVADORES</h1>
</div>

<div class="col-lg-6" style="margin-left: 25%;">                                                                                                                                                                                                                                    
    <form id="novaRegraEmpresa" name="novaRegraEmpresa" method="POST" action="../bd/novaRegraAp.php?id_usuario='. $_GET['id_usuario'] .'">
