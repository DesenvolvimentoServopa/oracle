...
if ($_GET['id'] != NULL) {
    ...
    <!-- INICIO DO CONTEUDO DA PÁGINA -->
        ...
        <h1 class="text-xs mb-6 text-gray-800 style="margin-left: 109px;"">
            ...
            <i class="fas fa-user-plus"></i> Editar Regra Departamento NF
        </h1>
    
        <div class="text-center">
            <h1 class="h3 mb-4 text-gray-800">EDITAR REGRA DEPARTAMENTO NF</h1>
        </div>
    
        
        <div class="col-lg-6" style="margin-left: 25%;">
                                                                                                                                                  
            <form id="novaRegraDeptoRH" name="novaRegraDeptoRH" method="POST" action="../bd/editDepNF.php?id='.$_GET['id'].'&id_usuario=' .$_GET['id_usuario']. ' >
                <div>
                ...
                <a class="btn btn-danger" href="smartshare_pag.php?id_drop=10&id_usuario=' .$_GET['id_usuario']. '">Voltar</a>
                <!-- BOTÃO SALVAR -->   
