...
<div class="container">
    ...
    <!-- Page Cabeçalho -->
    <title>Nova Regra Empresa Departamento</title>
    <h1 class="text-xs mb-6 text-gray-800 style="margin-left: 109px;"">
        ...
        <i class="fas fa-user-plus"></i> Nova Regra Empresa Departamento
    </h1>

    <div class="text-center">
        <h1 class="h3 mb-4 text-gray-800">NOVA REGRA EMPRESA X DEPARTAMENTO RH</h1>
    </div>

    <div class="col-lg-6" style="margin-left: 25%;">                                                                                                             
        <form id="novaRegraEmpDep" name="novaRegraEmpDep" method="POST" action="../bd/novaRegraEmpDep.php?id_usuario='.$_GET['id_usuario'].'" class="form-group">
            <div>
            ...
            <div class="form-group">
                ...
                <select class="form-control" placeholder="Departamento" name="depto" type="text" id="depto" required>';
                    ...
                    $departrh .= " WHERE d.situacao = 'A' ORDER BY NOME_DEPARTAMENTO ASC";

                    $resultDpto = oci_parse($conn, $departrh);
