...
<!-- INICIO DO CONTEUDO DA PÁGINA -->
    ...
    <!-- Page Cabeçalho -->
    <title>Nova Regra Departamento NF</title>
    <h1 class="text-xs mb-6 text-gray-800 style="margin-left: 109px;"">
        ...
        <i class="fas fa-user-plus"></i> Nova Regra Departamento NF
    </h1>

    <div class="text-center">
        <h1 class="h3 mb-4 text-gray-800">Nova Regra Departamento NF</h1>
    </div>

    
    <div class="col-lg-6" style="margin-left: 25%;">
        <form id="novaRegraDeptoRH" name="novaRegraDeptoRH" method="POST" action="../bd/novaRegraDepNF.php?id_usuario=' .$_GET['id_usuario']. '">
            <div>
