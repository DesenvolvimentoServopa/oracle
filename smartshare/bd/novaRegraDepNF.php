...
if (($rowdpto = oci_fetch_array($resultrh, OCI_BOTH)) != FALSE) {
    ...
    header('location: ../front/smartshare_pag.php?id_drop=10&msn=4&id_usuario='. $_GET['id_usuario'] .''); //msn dpto inserido com sucesso
...
//salvar o departamento
    ...
    if(ociexecute($resultInsert)){
        header('location: ../front/smartshare_pag.php?id_drop=10&msn=1&id_usuario='. $_GET['id_usuario'] .''); //msn dpto inserido com sucesso
    }else{
