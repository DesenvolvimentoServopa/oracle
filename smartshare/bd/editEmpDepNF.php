...
$updateEmpDep = "UPDATE empresa_departamento_nf
                SET
...
if(ociexecute($resultUptEmpDep)) {
    header('location: ../front/smartshare_pag.php?id_drop=11&msn=2&id_usuario='. $_GET['id_usuario'] .''); //msn=2 Regra editada com sucesso.
}else{
